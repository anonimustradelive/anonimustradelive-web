...
- **FAQ:** se cayeron tres preguntas que quedaron falsas. "¿Puedo cambiarme de tanda?" (ya no hay tandas), "¿Por qué no hay grabaciones?" (ahora sí se graban, aunque no se anuncia como argumento de venta) y "¿Por qué no hay testimonios?" (ya hubo un grupo). **Pendiente:** montar los testimonios reales de la primera convocatoria cuando el dueño los entregue
